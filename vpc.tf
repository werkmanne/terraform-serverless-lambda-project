...
resource "aws_subnet" "public_subnet_az1" {
  ...
  tags = {
    Name = "${var.project_name}-${var.environment}-public-subnet-az-1"
  }
}
...
resource "aws_subnet" "public_subnet_az2" {
  ...
  tags = {
    Name = "${var.project_name}-${var.environment}-public-subnet-az-2"
  }
}
...
resource "aws_subnet" "private_subnet_az1" {
  ...
  tags = {
    Name = "${var.project_name}-${var.environment}-private-subnet-az-1"
  }
}
...
resource "aws_subnet" "private_subnet_az2" {
  ...
  tags = {
    Name = "${var.project_name}-${var.environment}-private-subnet-az-2"
  }
}